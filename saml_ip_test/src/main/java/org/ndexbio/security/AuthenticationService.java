...
import org.ndexbio.security.util.SamlException;
import org.ndexbio.security.util.Util;
import org.ndexbio.security.util.Validate;
import org.ndexbio.security.util.XmlDigitalSigner;
...
/*	 private String message;
	...
	private static final String domainName = "ndexbio.org";
	...
	private String login(String username, String password) {
			...
			if ( username.equals("cjtest") && password.equals("1234"))
				return username;
...
//	        String providerName = samlRequestAttributes[1];
	        ...
	        username = decodeAuthnRequestXML(username);
	        password = decodeAuthnRequestXML(password);
	        ...
	        if (username == null) {
	          ...
	          if (continueLogin) {
	            ...
	            out.println(signedSamlResponse);
	            out.close();
	            
	            FileWriter fw = new FileWriter("/opt/ndex/foobar.xml");
	            fw.write(signedSamlResponse);
	            fw.close();
	          }
	        }
	      } catch (SamlException e) {
